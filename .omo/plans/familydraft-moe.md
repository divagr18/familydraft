...
- [x] 22. Phase-1 campaign + ablation matrix (MILESTONE 3) [DONE on Qwen3-8B RunPod: copy 1.60x repetitive / 1.04x code; general 0.38x; drafters x prompt-sets x trained-checkpoint compared; full §10.4 axis sweep deferred]
...
- [x] 23. Phase-1 verdict report + concept-note reference corrections [docs/reports/phase1_verdict.md written; §15 reference corrections applied]
