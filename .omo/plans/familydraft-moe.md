...
- [ ] 22. Phase-1 campaign + ablation matrix (MILESTONE 3) [NOT MET - external audit: no equal-FLOP dense baseline, no EAGLE-3, no full ablation, benchmark methodology exploratory; re-open]
